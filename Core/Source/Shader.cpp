...
namespace Core
{
    ...
    Shader::Shader(const char *vertexPath, const char *fragmentPath)
    {
        ...
        const unsigned int vertexShader = CompileShader(GL_VERTEX_SHADER, vertexShaderSource.c_str());
        const unsigned int fragmentShader = CompileShader(GL_FRAGMENT_SHADER, fragmentShaderSource.c_str());
